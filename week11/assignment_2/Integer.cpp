...
Number *Integer::add(Number * num) {
    ...
    if (num->types() == INTEGER) {
		...
		delete(num);
		Number* b = new Integer(test->val() + this->val());
		return b;
		...
		int a = this->val();
		delete(this);
		Number* b = new Complex(test->real() + a, test->imag());
		return b;
...
Number *Integer::sub(Number * num) {
	...
	if (num->types() == INTEGER) {
		...
		delete(num);
		double a = this->val();
		Number* b = new Integer(a - test->val());
		return b;
		...
		double a = this->val();
		delete(this);
		Number* b = new Complex(a - test->real(), -test->imag());
		return b;
...
Number *Integer::mul(Number * num) {
	...
	if (num->types() == INTEGER) {
		Integer* test = dynamic_cast<Integer*>(num);
		delete(num);
		Number* b = new Integer(this->val() * test->val());
		return b;
		...
		double a = this->val();
		delete(this);
		Number* b = new Complex(a * test->real(), a * test->imag());
		return b;
...
Number *Integer::div(Number * num) {
	...
	if (num->types() == INTEGER) {
		...
		Float* test = dynamic_cast<Float*>(num);
		double a = this->val();
		Number* b = new Float(this->val() / test->val());
		delete(this);
		return b;
